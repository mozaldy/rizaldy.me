                        ...
                        <div ref={profileContentRef} className="flex flex-col space-y-6 md:space-y-8 text-center md:text-left justify-center text-foreground mt-80 md:mt-0">
                            ...
                            <div className="pt-4 flex flex-col items-center md:items-start gap-4">
                                <div className="flex space-x-4">
                                    ...
                                    <a href={profileData.socials.github} className="text-foreground transition-transform hover:scale-110" aria-label="GitHub">
                                    ...
                                    <a href={profileData.socials.instagram} target="_blank" rel="noopener noreferrer" className="text-foreground transition-transform hover:scale-110" aria-label="Instagram">
